...
name: VNET (Virtual Network)
tags: 
- Azure
- Cloud

---
-   An [Azure](Azure/Azure.md) Virtual Network (VNet) is a network or environment that can be used to run VMs and applications in the cloud.
-   When it is created, the services and Virtual Machines within the Azure network in
- teract securely with each other.
- It is similar to the [[VPC]] service provided by AWS
